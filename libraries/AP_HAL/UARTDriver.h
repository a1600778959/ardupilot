...
public:
    ...
    enum Option {
        ...
        OPTION_MAVLINK_NO_FORWARD_old = (1U<<10), // moved to MAVn_OPTIONS bit 1
        OPTION_NOFIFO             = (1U<<11), // disable hardware FIFO
        OPTION_NOSTREAMOVERRIDE_old = (1U<<12), // moved to MAVn_OPTIONS bit 2
    };

    bool option_is_set(Option option) const {
        return (_last_options & static_cast<uint16_t>(option)) != 0;
    }
