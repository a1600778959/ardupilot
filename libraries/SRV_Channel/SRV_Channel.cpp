...
const AP_Param::GroupInfo SRV_Channel::var_info[] = {
    ...
    // @Values{Rover}: -1:GPIO,0:Disabled,1:RCPassThru,10:CameraTrigger
    // @Values{Rover}: 51:RCIN1,52:RCIN2,53:RCIN3,54:RCIN4,55:RCIN5,56:RCIN6,57:RCIN7,58:RCIN8
    // @Values{Rover}: 59:RCIN9,60:RCIN10,61:RCIN11,62:RCIN12,63:RCIN13,64:RCIN14,65:RCIN15,66:RCIN16
    // @Values{Rover}: 73:ThrottleLeft,74:ThrottleRight
    // @Values{Rover}: 90:CameraISO,91:CameraAperture,92:CameraFocus,93:CameraShutterSpeed
    // @Values{Rover}: 94:Script1,95:Script2,96:Script3,97:Script4,98:Script5,99:Script6,100:Script7,101:Script8
    // @Values{Rover}: 102:Script9,103:Script10,104:Script11,105:Script12,106:Script13,107:Script14,108:Script15,109:Script16
    // @Values{Rover}: 120:NeoPixel1,121:NeoPixel2,122:NeoPixel3,123:NeoPixel4
    // @Values{Rover}: 129:ProfiLED1,130:ProfiLED2,131:ProfiLED3,132:ProfiLEDClock
    // @Values{Rover}: 134:SERVOn_MIN,135:SERVOn_TRIM,136:SERVOn_MAX,138:Alarm,139:Alarm Inverted
    // @Values{Rover}: 140:RCIN1Scaled,141:RCIN2Scaled,142:RCIN3Scaled,143:RCIN4Scaled,144:RCIN5Scaled,145:RCIN6Scaled
    // @Values{Rover}: 146:RCIN7Scaled,147:RCIN8Scaled,148:RCIN9Scaled,149:RCIN10Scaled,150:RCIN11Scaled
    // @Values{Rover}: 151:RCIN12Scaled,152:RCIN13Scaled,153:RCIN14Scaled,154:RCIN15Scaled,155:RCIN16Scaled
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO_FRAME("FUNCTION",  5, SRV_Channel, function, 0, AP_PARAM_FRAME_ROVER),
