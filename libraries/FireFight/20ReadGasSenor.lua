...
-- Modbus读取命令
local modbus_cmd = {0x01, 0x03, 0x00, 0x00, 0x00, 0x26,0x00,0x00}
...
local function parse_response(buffer_rx)
    ...
    local temp = (buffer_rx[4] + buffer_rx[5]*256 + buffer_rx[6]*65536 + buffer_rx[7]*16777216);
...
local function receive_modbus_response()
    ...
    while n_bytes > 0 do
        ...
        elseif stat == 1 and byte == 0x03 then
            ...
            cur_count = 2;
            stat = 2;
        elseif  stat == 2 and byte == 40 then
