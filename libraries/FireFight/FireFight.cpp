...
{
    static uint16_t time_count_ms_T7 = 0;
    static uint16_t time_count_ms_water_press = 0;
    // static uint8_t lock_flag_T7 = 0;  //当持续拨动某个杠超过1s时候则置位
    static int16_t Push_rod_fan_ID_2 = 0; // 推杆电机
    static int16_t Self_spraying_ID3 = 0, Push_rod_fan_ID_1 = 0;
    static int16_t release_belt_ID_1 = 0;
    ...
    if ((abs(T_8 - 1500) > 100  )||E_g.gases.waterpress > 100)
    {
    ...
    if (abs(T_7 - 1500) > 100)
    {
        ...
        {
            // lock_flag_T7 = 1;
            (T_7 - 1500) < 0 ? release_belt_ID_1 = 0: release_belt_ID_1 = 1;
        }
        else
        {
    ...
    write_six(2, 12, Push_rod_fan_ID_1, Push_rod_fan_ID_2, Push_rod_fan_ID_1, Push_rod_fan_ID_2, release_belt_ID_1, Self_spraying_ID3);
