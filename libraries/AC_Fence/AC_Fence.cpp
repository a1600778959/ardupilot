...
#define AC_FENCE_DUMMY_METHODS_ENABLED  (!(APM_BUILD_TYPE(APM_BUILD_Rover) | (AP_FENCE_ENABLED == 1)))
#endif
...
const AP_Param::GroupInfo AC_Fence::var_info[] = {
    ...
    // @Description: Configured Rover fence types held as bitmask.
    ...
    // 3 reserved for a removed parameter
    ...
    // 7 to 11 reserved for removed parameters
