...
class upload_fw(Task.Task):
    ...
    def wsl2_prereq_checks(self):
        ...
        import subprocess
        where_python = "C:\\Users\\master\\AppData\\Local\\Microsoft\\WindowsApps\\python.exe"
...
def setup_canmgr_build(cfg):
    ...
    the build based on the presence of CAN pins in hwdef.dat except for peripheral builds'''
    env = cfg.env
    env.AP_LIBRARIES += [
        'AP_DroneCAN',
